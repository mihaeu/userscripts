...
(function() {
    ...
    document.querySelector('nav[aria-label="Global"]').innerHTML += `
        <a class="js-selected-navigation-item selected Header-link  mr-0 mr-lg-3 py-2 py-lg-0 border-top border-lg-top-0 border-white-fade-15" href="https://github.com/trending">
        ...
        <a class="js-selected-navigation-item selected Header-link  mr-0 mr-lg-3 py-2 py-lg-0 border-top border-lg-top-0 border-white-fade-15" href="https://github.com/stars">
